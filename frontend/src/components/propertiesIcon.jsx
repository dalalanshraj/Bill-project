  ...
  const properties = [
    {
      ...
      links: {
        ...
        airbnb:
          "https://www.airbnb.com/h/BeachTimeAtGrandPanamaResortinPCB",
      },
    },
    {
      id: 2,
      ...
      links: {
        ...
        airbnb:
          "https://www.airbnb.com/h/BeachTimeAtCalypsoTower3inPCB",
      },
    },
  ];
    ...
    <section className="w-full bg-white py-20 px-5">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="font-playfair text-4xl sm:text-5xl md:text-6xl font-bold text-black">
            Book Your Way
          </h2>
